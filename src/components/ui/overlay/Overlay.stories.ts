  ...
  render: () => ({
    ...
    template: `
      <div style="position: relative; width: 100%; height: 300px; border-radius: var(--radius-md); overflow: hidden; border: 1px solid var(--color-border-default);">
        ...
        <div style="padding: var(--spacing-9); background: var(--color-surface-default); height: 100%; box-sizing: border-box;">
          <h3 style="margin: 0 0 var(--spacing-6) 0; font-family: var(--font-family-body); font-size: var(--font-size-text-big); color: var(--color-text-primary);">
            Panel de control principal
          </h3>
          <p style="margin: 0 0 var(--spacing-7) 0; font-family: var(--font-family-body); font-size: var(--font-size-text-small); color: var(--color-text-secondary);">
            Este texto y elementos simulan el contenido subyacente que queda atenuado bajo el Overlay.
          </p>
          <div style="display: flex; gap: var(--spacing-6);">
            <div style="width: 80px; height: var(--sizing-10); background: var(--color-surface-muted); border-radius: var(--radius-md);"></div>
            <div style="width: 120px; height: var(--sizing-10); background: var(--color-surface-muted); border-radius: var(--radius-md);"></div>
          </div>
        </div>
