...
<div className="principles-grid">
  ...
  <div className="principle-card">
    ...
    <p>Using variants simplifies UI maintenance and reviews by keeping all icons within a clear set of rules. It also allows for automated visual testing and consistent theming adjustments (e.g., color changes, padding).</p>
  </div>
  <div className="principle-card">
    <h4>Accesibility</h4>
...
Explorador interactivo con los **456 componentes de icono extraídos 1:1 de Figma** con sus vectores SVG originales, categorías, selector de tamaño y buscador:
