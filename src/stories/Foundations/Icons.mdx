...
## Icon Explorer & Configurator (456 Iconos de Figma)

Usa el buscador, filtra por categorías o selecciona tamaños y colores interactivos. Haz click en cualquier icono para copiar su nombre exacto de Figma.

<Canvas of={IconStories.Explorer} />
